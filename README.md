...
**Seach Bar** -  Users can now search for their projects.
...
**Features with Description!** - Users can now create an "elevator pitch" for their features to help voters make their choices.
